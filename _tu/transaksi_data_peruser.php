...
if (empty($_SESSION['user_id']) || $_SESSION['adm_level'] !='Tata Usaha'){
  ...
  /*if(isset($_POST['nis']) ==null){
    $transcari_redirect_url = "transaksi_cari_peruser.php";
    echo "<script>alert('NIS Siswa Tidak Boleh Kosong !'); window.location = '$transcari_redirect_url'</script>";
  } else if(is_numeric($_POST['nis']) == FALSE){
    $transcari_redirect_url = "transaksi_cari_peruser.php";
    echo "<script>alert('NIS Siswa Harus Berupa Angka !'); window.location = '$transcari_redirect_url'</script>";
  } else {
    $nis_post = $_POST['nis']; 
  }**/
          ...
          <div class="box">
            ...
            <!--<div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" readonly value="<?php echo $qr['nis_bayar']; ?>" >
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2">Nama</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" readonly value="<?php echo $qr['nama_siswa']; ?>" >
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2">Kelas</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" readonly value="<?php echo $qr['kls_siswa']." / ".$qr['jk_siswa']; ?>" >
                </div>
              </div>
            </form>
            </div></div></div>
