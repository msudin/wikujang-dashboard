          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $no = 0; 
                $kelasmodal = mysqli_query($koneksi, "SELECT * FROM tb_spp"); 
                ...
                <tr>
                  ...
                  <td align="center">
                    <a href="#" class="delete-modal btn btn-danger btn-sm" onclick="confirm_modal('spp_delete_proses.php?modal_id=<?php echo $kls['id_spp']; ?>');">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="spp_add_proses.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                <div class="form-group">
