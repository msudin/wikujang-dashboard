        ...
        <div class="modal-body">
        	<form action="../_report/cetak/faktur_multiple.php" name="modal_popup" enctype="multipart/form-data" method="POST" target="_blank">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="modal_id"  class="form-control" value="<?php echo $modal_id; ?>" />
     				<input type="text" name="modal_name"  class="form-control" value="<?php echo $modal_id; ?>" readonly required />
                </div>
