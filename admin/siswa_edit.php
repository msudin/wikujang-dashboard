        ...
        <div class="col-md-12">
          ...
          <!-- form start -->
            <div class=" box box-body">
              <form class="form-horizontal" action="siswa_uc.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="hidden" name="uc_type" value="update" readonly >
