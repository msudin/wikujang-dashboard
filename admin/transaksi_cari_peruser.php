...
if(array_key_exists('typeLogin', $_SESSION)){
  if($_SESSION['typeLogin'] == "0"){
    body();
  } else {
...
?>
  ...
  <?php 
    function body(){ 
      $thisPage = "Transaksi Cari Peruser";
      include '../dbcon/config.php';
      if($_SESSION['typeLogin'] == "0"){
        $fullname = $_SESSION['adm_username'];
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
              ...
              <div class="col-md-4" style="padding-bottom: 50px;">
                ...
                <form action="transaksi_data_peruser.php" class="search-form" method="POST">
            ...
            <!-- /.error-page -->
            <?php  if($_SESSION['typeLogin'] == "0") { ?>
              <div class="alert alert-info">
                      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      <font color="black"><h4> Informasi !</h4>
                      **) Informasi / bantuin teknis lebih lanjut silahkan hubungi Administator.
                      </font>
                    </div>
            <?php } else { ?>
              <div class="alert alert-info">
