      ...
      <?php  if($_SESSION['typeLogin'] == "0"){ ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li <?php if($thisPage == "Data Transaksi Persiswa") echo "class='active'"; ?>><a href="transaksi_cari_peruser.php"><i class="fa  fa-clone"></i>Siswa</a></li>
              </ul>
            </li>
          </ul>
        <?php } else { ?>
