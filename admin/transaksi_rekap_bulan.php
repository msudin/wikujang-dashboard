...
$(document).ready(function(){
    $('.btn-success').click(function (e){
      ...
      $("#printabel").remove();
      loadOtherPage1(bulan, kelas, tahun);
    });
  });


  function loadOtherPage1(bulan, kelas, tahun) {
    ...
    $("<iframe id='printabel'>")    
        .hide()                     
        .attr("src", "../_report/cetak/report_bulan.php?bulan="+bulan+"&kelas="+kelas+"&tahun="+tahun) 
        .appendTo("body");           
    }
</script>
</body>
