    ...
    <div>
            ...
            <td align='left' style=' vertical-align:top; width:100px'>
                <table style=' border-collapse: collapse;'>
                    <tr>
                        ...
                        <td width='1%' style='font-size:11pt'>:</td>
                        <td style='font-size:11pt; padding-left:4px;'><?php echo $ds['nis_bayar']; ?> /
                            <?php echo $ds['kls_bayar']; ?></td>
                    </tr>
                </table>
            </td>
        ...
        <table style='width:280px; font-size:11pt; font-family:calibri;  border-collapse: collapse; padding-top:50px;'>
            ...
            <tr>
                ...
                <td style='padding-left:10px; text-align:left;'>Titipan Infaq ke -
                    <?php echo convertInfaqMultiple($bulan1, $bulan2); ?></td>
...
function penyebut($nilai) {
	...
	?>
        <table cellspacing='0'
            style='width:280px; height:30px; font-size:11pt; font-family:calibri;  border-collapse: collapse; padding-top:20px; margin-top:-20px;  margin-bottom:10px;'>
