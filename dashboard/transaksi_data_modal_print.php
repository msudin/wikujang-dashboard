<?php
    ...
    $sql = mysqli_query($koneksi, "SELECT * FROM tb_pembayaran tb_pembayaran INNER JOIN tb_siswa ON tb_pembayaran.nis_bayar=tb_siswa.id_nis WHERE id_bayar='$id_bayar'"); 
    $ds = mysqli_fetch_array($sql); 
    $bulan_bayar = convertinfaq($ds['bulan_bayar']);
?>
...
<div class="modal-dialog">
    ...
    <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Cetak SPP</h4>
    </div>
    <div>
    <center>
        ...
        <table style='width:280px; font-size:11pt; font-family:calibri;  border-collapse: collapse; padding-top:50px;'>
            ...
            <tr>
                ...
                <td style='padding-left:10px; text-align:left;'>Titipan <?php echo $bulan_bayar; ?></td>
	...
	?>
        ...
        <button id="print" class="btn btn-success" type="submit">
                Print
            </button>
   ...
   <script>
        ...
        function loadOtherPage1() {
            $("<iframe id='printabel'>")    
                .hide()                     
                .attr("src", "../_report/cetak/faktur.php?id_trans=<?=$id_bayar?>") 
                .appendTo("body");           
            }
    </script>
    </body>
