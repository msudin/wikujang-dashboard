              ...
              <div class="box-body table-responsive no-padding">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no = 0; 
                    $dataList = getWithdrawList(NULL, "transfered");
                  ...
                  <tr>
                    ...
                    <td><?=withdrawStatusColorName($data->type == "refund" ? "refund" : $data->status)?></td>
                    <td><?=rupiah0($data->type == "withdraw" ? $data->debit : $data->credit)?></td>
